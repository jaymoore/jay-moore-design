...
const ITEMS: DepthItem[] = [
  ...
  },
  {
    ...
    body: "10 yrs product design into design engineering. Fiserv, Kleinfelder, SPM. The cross-domain bridge.",
    cta: "Background",
    href: "/about",
  },
  {
    number: "03",
    title: "Get in touch",
    body: "Open to Staff / Principal Design Engineer roles. US remote.",
    cta: "Contact",
